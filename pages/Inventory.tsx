...
const VehicleCard: React.FC<VehicleCardProps> = ({ vehicle, onClick, lang }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className="group relative bg-black transition-all duration-500 ease-out hover:scale-[1.01] hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(212,175,55,0.15)] hover:z-30 border border-transparent hover:border-tj-gold/40 flex flex-col h-full cursor-pointer select-none overflow-hidden"
    >
  ...
  return (
    <div className="bg-black min-h-screen px-4 md:px-6 pb-20 relative">
      ...
      <div className="max-w-[1800px] mx-auto relative z-10">
        ...
        <div className="pt-24 pb-12 border-b border-white/10 flex flex-col md:flex-row justify-between items-end gap-8">
          <div>
            ...
            <h1 className="font-display text-5xl md:text-8xl text-white tracking-tight leading-none">{t[lang].title.toUpperCase()}</h1>
          </div>
      ...
      {selectedVehicle && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-0 md:p-6" style={{ overscrollBehavior: 'none' }}>
          ...
          <div className="relative w-full h-[100dvh] md:h-[85vh] md:max-h-[800px] max-w-7xl bg-[#080808] md:border border-tj-gold/30 shadow-[0_0_100px_rgba(0,0,0,1)] flex flex-col md:flex-row overflow-hidden md:rounded-sm animate-opulent-reveal">
                         ...
                         <div className="animate-fade-in h-full flex flex-col">
                            {submitStatus === 'success' ? (
                                <div className="text-center py-8 flex-grow flex flex-col justify-center">
                                    ...
                                    <a href="tel:+18327777580" className="w-full bg-tj-gold text-black font-bold py-4 text-sm uppercase tracking-[0.2em] hover:bg-white transition-colors flex items-center justify-center gap-2 mb-4">
