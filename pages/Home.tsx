...
import { ArrowRight, Diamond, Hexagon, ChevronDown, Brain, Zap, Fingerprint, Scan, Target, Shield, Lock, Activity, Crosshair, Wifi } from 'lucide-react';
...
const SubliminalPrime = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none mix-blend-overlay">
      <h2 className="text-[20vw] font-display font-black text-white/10 tracking-tighter uppercase scale-150 animate-pulse">
        {word}
      </h2>
    </div>
  );
...
const Home = () => {
  ...
  return (
    <div className="bg-black overflow-hidden font-sans selection:bg-tj-gold selection:text-black">
      <SubliminalPrime />
      ...
      <div className="relative h-screen flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
             ...
             <div 
                className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?q=80&w=2830&auto=format&fit=crop')] bg-cover bg-center transition-transform duration-100 ease-out"
                style={{ 
                    transform: `scale(1.1) translate(${mousePos.x * -20}px, ${mousePos.y * -20 + scrollY * 0.2}px)`, 
        ...
        <div className="relative z-10 text-center px-6 w-full max-w-[1920px]">
          {/* Status Bar - Gamified HUD */}
          <div className="flex justify-between items-center w-full max-w-5xl mx-auto mb-16 opacity-0 animate-fade-in border-t border-b border-white/5 py-3 backdrop-blur-sm">
          ...
          <h1 className="font-display text-[13vw] md:text-[11vw] leading-[0.8] text-white tracking-tighter mix-blend-difference mb-12 select-none perspective-1000">
            <span 
                className="block opacity-0 animate-slide-up transform transition-transform duration-200" 
                style={{
                    animationDelay: '0.2s',
            ...
            <span 
                className="block text-transparent bg-clip-text bg-gradient-to-b from-tj-gold via-yellow-600 to-transparent opacity-0 animate-slide-up" 
                style={{
                    animationDelay: '0.4s',
                    transform: `rotateX(${mousePos.y * -10}deg) rotateY(${mousePos.x * -10}deg)`
                }}
          ...
          <div className="flex flex-col items-center gap-6 opacity-0 animate-slide-up" style={{animationDelay: '0.8s'}}>
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-12 animate-bounce text-tj-gold/50 flex flex-col items-center gap-2 cursor-pointer mix-blend-difference" onClick={() => window.scrollTo({top: window.innerHeight, behavior: 'smooth'})}>
      ...
      {/* Designed for the "Short Attention Span" - Show the goods immediately */}
      {hasAssets && (
              ...
              <div className="max-w-[1920px] mx-auto px-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {featuredAssets.map((vehicle, idx) => (
                          <Link to="/inventory" key={vehicle.id} className="group relative aspect-[3/4] md:aspect-[4/5] overflow-hidden border border-white/10 bg-gray-900 cursor-pointer">
      ...
      <section className="py-24 px-6 max-w-[1920px] mx-auto bg-black">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10 border border-white/10">
            {/* Pillar 1 */}
            <div className="bg-tj-dark p-10 group hover:bg-white/5 transition-colors duration-500 relative overflow-hidden h-[350px] flex flex-col justify-between">
               <div>
