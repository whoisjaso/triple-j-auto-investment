        ...
        <section className="mb-16 bg-red-900/10 border border-red-900/30 p-12">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-red-500 text-xs uppercase tracking-widest">No Warranties &bull; No Returns</p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Debit Card:</strong> Accepted for deposits and payments</li>
