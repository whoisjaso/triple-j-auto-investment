    ...
    <div ref={containerRef} className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          autoComplete="off"
          className="w-full bg-black border border-gray-700 pl-10 pr-10 py-3 text-white text-sm focus:border-tj-gold outline-none transition-colors placeholder-gray-600"
        />
        {isLoading && (
