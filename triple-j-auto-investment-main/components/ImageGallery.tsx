...
export const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  useEffect(() => {
    ...
    const handleKey = (e: KeyboardEvent) => {
      ...
      // Focus trap: cycle Tab within gallery
      if (e.key === 'Tab' && galleryRef.current) {
            ...
            <div className="flex items-center justify-between max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="p-3 text-white/80 hover:text-tj-gold transition-colors focus:outline-none focus:ring-2 focus:ring-tj-gold"
          ...
          <div className="flex-grow relative overflow-hidden">
            ...
            {images.length > 1 && (
              <>
                <button
                  onClick={goPrev}
                  className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 z-10 items-center justify-center w-12 h-12 text-white/70 hover:text-tj-gold bg-black/50 hover:bg-black/80 transition-all border border-white/10 hover:border-tj-gold/50 focus:outline-none focus:ring-2 focus:ring-tj-gold"
                ...
                <button
                  onClick={goNext}
                  className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 z-10 items-center justify-center w-12 h-12 text-white/70 hover:text-tj-gold bg-black/50 hover:bg-black/80 transition-all border border-white/10 hover:border-tj-gold/50 focus:outline-none focus:ring-2 focus:ring-tj-gold"
