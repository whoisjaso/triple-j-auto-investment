...
must_haves:
  ...
  artifacts:
    - path: "triple-j-auto-investment-main/supabase/functions/_shared/twilio.ts"
      provides: "sendSms() helper using Twilio REST API"
      exports: ["sendSms"]
    - path: "triple-j-auto-investment-main/supabase/functions/_shared/resend.ts"
      provides: "sendEmail() helper using Resend REST API"
      exports: ["sendEmail"]
    - path: "triple-j-auto-investment-main/supabase/functions/_shared/email-templates/status-update.tsx"
      provides: "HTML email template for stage change notifications"
      exports: ["renderStatusUpdateEmail"]
    - path: "triple-j-auto-investment-main/supabase/functions/_shared/email-templates/rejection-notice.tsx"
      provides: "HTML email template for rejection notifications"
      exports: ["renderRejectionEmail"]
    - path: "triple-j-auto-investment-main/supabase/functions/process-notification-queue/index.ts"
      provides: "Edge Function that processes debounced notification queue"
      contains: "Deno.serve"
    - path: "triple-j-auto-investment-main/supabase/functions/unsubscribe/index.ts"
