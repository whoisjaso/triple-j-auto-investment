...
- [ ] 16-02-PLAN.md -- Attribution capture: UTM persistence, captureAttribution service, auto-fill attribution on all lead creation
...
- [ ] 18-03-PLAN.md -- (Gap closure) Fix deduplication index to include channel column for Tier 3 dual-channel SMS + email
