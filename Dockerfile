...
ARG VITE_RETELL_OUTBOUND_AGENT_ID
ARG VITE_RETELL_OUTBOUND_NUMBER
...
ENV VITE_RETELL_OUTBOUND_AGENT_ID=$VITE_RETELL_OUTBOUND_AGENT_ID
ENV VITE_RETELL_OUTBOUND_NUMBER=$VITE_RETELL_OUTBOUND_NUMBER
