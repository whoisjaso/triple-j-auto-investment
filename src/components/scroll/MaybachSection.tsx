        ...
        promises.push(
          (async () => {
            try {
              ...
              const resp = await fetch(`/maybach-frames/frame-${num}.webp`);
    ...
    >
      ...
      >
        ...
        <img
          ...
          alt=""
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[85vw] h-auto object-contain md:hidden"
          style={{
            WebkitMaskImage:
