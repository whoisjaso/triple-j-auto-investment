...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* ══════════ DESKTOP SIDEBAR ══════════ */}
      <aside className="hidden md:flex fixed top-0 left-0 bottom-0 z-50 w-60 bg-black border-r border-white/[0.04] flex-col print:!hidden print:!static print:!w-0 print:!h-0 print:!overflow-hidden">
